                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">
                            <a href="#" class="underline text-gray-900 dark:text-white"></a></a> <a href="{{ URL::previous() }}">Retornar</a>
                        </div>
                    </div>

                    <div class="ml-14">
                        <div class="mt-43 text-gray-700 dark:text-gray-400 text-sm"  style="width:1000px;">
