                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-t-0 md:border-l">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold">
                            <a href="#" class="underline text-gray-900 dark:text-white"><p>Clique aqui para buscar os dados</p></a>
                        </div>
                    </div>

                    <div class="ml-14">
                        <div class="mt-43 text-gray-700 dark:text-gray-400 text-sm">
                                        ...
                                        .done(function(evt) {
                                            ...
                                            setTimeout(function(){
                                                ...
                                                html +='<header>Funceme - Dados Carregados -</header>'
                                                    ...
                                                    +'</div>'
                                                    +'<table class="table table-hover" overflow="scroll" style="width:1000px;border:1px solid">'
                                                    +'<thead>'
                                                    +'<tr>'
                                                    +'<th scope="col">ID</th>'
                                                ...
                                                html +='<a href="graficos"> Visualizar em gráfico </a></table>'
                                                html +='<footer class="navbar navbar-inverse navbar-fixed-bottom" style="background-color: #4682B4; border-color: #4682B4; width:1000px;>';
                                                html +='<div class="container-fluid">';
                                                html +='<p class="text-muted"><font color="#FFFFFF">&nbsp; MARCUS PAULO - +55 85 98669.1853</font></p>';
                                                html +='</div>';
                                                html +='</div>';
                                                $('.table').html(html);
                                            },1000);
